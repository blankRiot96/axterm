...
class HorizontalSlider:
    ...
    def draw(self, surface: pygame.Surface) -> None:
        pygame.draw.rect(surface, self.bg_color, self.rail, border_radius=10)
        pygame.draw.circle(surface, self.fg_color, (self.x, self.y), self.radius)
